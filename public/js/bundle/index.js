...
const initMapbox = (locations)=>{
    ...
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/jdeejat/cj20he7w700402rmjs5zfkwlj",
        // scrollZoom: false,
    ...
    locations.forEach((loc)=>{
        ...
        .setHTML(`<a href='${loc.googleMapsLink}' target="_blank">${loc.pointName}</a>`)).addTo(map);
        // add popup OLD
...
},{"./alert":"bRZBd","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"1qbEl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadMore", ()=>loadMore);
/* eslint-disable */ var _alert = require("./alert");
const loadMore = async (page = 0, limit = 9)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5Birt","./alert":"bRZBd"}]},["7zAMY","4uyBp"], "4uyBp", "parcelRequire809a")
